#!/usr/bin/env python3
"""
Playwright POC test for microsoft--RD-Agent.

Usage:
    python tutorial_microsoft--RD-Agent_playwright.py [--url http://127.0.0.1:11290]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for microsoft--RD-Agent."""
