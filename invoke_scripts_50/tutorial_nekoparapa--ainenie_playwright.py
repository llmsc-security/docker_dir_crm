#!/usr/bin/env python3
"""
Playwright POC test for nekoparapa--ainenie.

Usage:
    python tutorial_nekoparapa--ainenie_playwright.py [--url http://127.0.0.1:11460]
"""
...
# ============== CONFIGURATION ==============
REPO_NAME = "nekoparapa--ainenie"
DEFAULT_PORT = 11460
# ===========================================


class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for nekoparapa--ainenie."""
