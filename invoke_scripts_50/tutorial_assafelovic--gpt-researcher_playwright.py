#!/usr/bin/env python3
"""
Playwright POC test for assafelovic--gpt-researcher.

Usage:
    python tutorial_assafelovic--gpt-researcher_playwright.py [--url http://127.0.0.1:11250]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for assafelovic--gpt-researcher."""
