#!/usr/bin/env python3
"""
Playwright POC test for yihong0618--bilingual_book_maker.

Usage:
    python tutorial_yihong0618--bilingual_book_maker_playwright.py [--url http://127.0.0.1:11450]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for yihong0618--bilingual_book_maker."""
