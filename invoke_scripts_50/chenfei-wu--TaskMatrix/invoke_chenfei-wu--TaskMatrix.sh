#!/bin/bash
# Invoke script for chenfei-wu--TaskMatrix
# Tests the HTTP service endpoint

set -e

REPO_NAME="chenfei-wu--TaskMatrix"
DOCKER_IMAGE="chenfei-wu--taskmatrix_image"
HOST="localhost"
HOST_PORT=11220
CONTAINER_PORT=11220

echo "============================================"
echo "Testing chenfei-wu--TaskMatrix on port $HOST_PORT"
echo "============================================"
...
BUILD_LOG="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/build_logs/chenfei-wu--TaskMatrix.build.log"
...
cd "/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/repo_dirs/chenfei-wu--TaskMatrix" || exit 1
