#!/usr/bin/env python3
"""
Playwright POC test for shroominic--codeinterpreter-api.

Usage:
    python tutorial_shroominic--codeinterpreter-api_playwright.py [--url http://127.0.0.1:11300]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for shroominic--codeinterpreter-api."""
