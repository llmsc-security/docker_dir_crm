#!/usr/bin/env python3
"""
Playwright POC test for NEKOparapa--AiNiee.

Usage:
    python tutorial_NEKOparapa--AiNiee_playwright.py [--url http://127.0.0.1:11460]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for NEKOparapa--AiNiee."""
