#!/bin/bash
# Invoke script for joshpxyne--gpt-migrate
# Tests the HTTP service endpoint

set -e

REPO_NAME="joshpxyne--gpt-migrate"
IMAGE_NAME="joshpxyne--gpt-migrate_image"
CONTAINER_NAME="joshpxyne--gpt-migrate_container"
PORT=11470
HOST="localhost"

echo "============================================"
echo "Testing joshpxyne--gpt-migrate on port $PORT"
echo "============================================"
