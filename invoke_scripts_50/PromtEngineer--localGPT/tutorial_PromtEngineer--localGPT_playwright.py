#!/usr/bin/env python3
"""
Playwright POC test for PromtEngineer--localGPT.

Usage:
    python tutorial_PromtEngineer--localGPT_playwright.py [--url http://127.0.0.1:11350]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for PromtEngineer--localGPT."""
