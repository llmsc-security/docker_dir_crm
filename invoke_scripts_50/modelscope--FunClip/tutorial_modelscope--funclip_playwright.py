#!/usr/bin/env python3
"""
Playwright POC test for modelscope--funclip.

Usage:
    python tutorial_modelscope--funclip_playwright.py [--url http://127.0.0.1:11430]
"""
...
# ============== CONFIGURATION ==============
REPO_NAME = "modelscope--funclip"
DEFAULT_PORT = 11430
# ===========================================


class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for modelscope--funclip."""
