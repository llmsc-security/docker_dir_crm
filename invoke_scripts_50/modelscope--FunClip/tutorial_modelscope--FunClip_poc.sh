#!/bin/bash
# Tutorial PoC script for modelscope--FunClip
# Tests the HTTP service endpoint

set -e

# Absolute paths
REPO_DIR="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/repo_dirs/modelscope--FunClip"
SCRIPTS_DIR="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/invoke_scripts_50/modelscope--FunClip"
BUILD_LOG_DIR="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/build_logs"
BUILD_LOG="${BUILD_LOG_DIR}/modelscope--FunClip.build.log"

# Port mapping from port_mapping_50_gap10_1.json
# modelscope--FunClip maps to base port 11430
HOST_PORT=11430
...
log_message "Starting tutorial PoC script for modelscope--FunClip"
log_message "Target service: http://127.0.0.1:${HOST_PORT}"

echo ""
echo "=============================================="
echo "modelscope--FunClip PoC - Testing Service Endpoints"
echo "=============================================="
echo ""
