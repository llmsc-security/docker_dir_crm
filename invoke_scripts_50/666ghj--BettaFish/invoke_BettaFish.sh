#!/bin/bash
# invoke script for 666ghj--BettaFish
...
if [ $BUILD_EXIT_CODE -eq 0 ]; then
    ...
    echo ""
    echo "=== Container Info ==="
    echo "Port mapping: 11370:5000"
    echo ""
    echo "=== To run the container ==="
    echo "docker run --rm -it \\"
    echo "  -p 11370:5000 \\"
    echo "  bettafish-image:latest"
    echo ""
    echo "=== Access the service ==="
    echo "Open http://localhost:11370 in your browser"
else
