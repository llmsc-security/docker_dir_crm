#!/usr/bin/env python3
"""
Playwright POC test for fynnfluegge--codeqai.

Usage:
    python tutorial_fynnfluegge--codeqai_playwright.py [--url http://127.0.0.1:11060]
"""
...
# ============== CONFIGURATION ==============
REPO_NAME = "fynnfluegge--codeqai"
DEFAULT_PORT = 11060
# ===========================================


class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for fynnfluegge--codeqai."""
