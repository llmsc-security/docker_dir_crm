...
# Absolute paths
REPO_DIR="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/repo_dirs/gptme--gptme"
SCRIPTS_DIR="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/invoke_scripts_50/gptme--gptme"
BUILD_LOG_DIR="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/build_logs"
BUILD_LOG="${BUILD_LOG_DIR}/gptme--gptme.build.log"

# Port mapping from port_mapping_50_gap10_1.json
# gptme--gptme maps to base port 11130
HOST_PORT=11130
...
log_message "Starting tutorial PoC script for gptme--gptme"
log_message "Target service: http://127.0.0.1:${HOST_PORT}"

echo ""
echo "=============================================="
echo "gptme--gptme PoC - Testing Service Endpoints"
echo "=============================================="
echo ""
