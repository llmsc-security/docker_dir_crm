#!/bin/bash
# Tutorial PoC script for bowang-lab--MedRAX
# Tests the HTTP service endpoint

set -e

# Absolute paths
REPO_DIR="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/repo_dirs/bowang-lab--MedRAX"
SCRIPTS_DIR="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/invoke_scripts_50/bowang-lab--MedRAX"
BUILD_LOG_DIR="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/build_logs"
BUILD_LOG="${BUILD_LOG_DIR}/bowang-lab--MedRAX.build.log"

# Port mapping from port_mapping_50_gap10_1.json
# bowang-lab--MedRAX maps to base port 11180
HOST_PORT=11180
...
log_message "Starting tutorial PoC script for bowang-lab--MedRAX"
log_message "Target service: http://127.0.0.1:${HOST_PORT}"

echo ""
echo "=============================================="
echo "bowang-lab--MedRAX PoC - Testing Service Endpoints"
echo "=============================================="
echo ""
