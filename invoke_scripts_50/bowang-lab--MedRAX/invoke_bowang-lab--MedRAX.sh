#!/bin/bash
# Invoke script for bowang-lab--MedRAX
# Tests the HTTP service endpoint

set -e

REPO_NAME="bowang-lab--MedRAX"
IMAGE_NAME="bowang-lab--medrax_image"
CONTAINER_NAME="bowang-lab--medrax_container"
PORT=11180
HOST="localhost"
CONTAINER_PORT=8585

echo "============================================"
echo "Testing bowang-lab--MedRAX on port $PORT"
echo "============================================"
