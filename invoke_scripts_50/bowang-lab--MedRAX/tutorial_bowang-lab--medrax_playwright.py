#!/usr/bin/env python3
"""
Playwright POC test for bowang-lab--medrax.

Usage:
    python tutorial_bowang-lab--medrax_playwright.py [--url http://127.0.0.1:11180]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for bowang-lab--medrax."""
