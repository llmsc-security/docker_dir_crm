#!/bin/bash
# Invoke script for acon96--home-llm
# Tests the HTTP service endpoint

set -e

REPO_NAME="acon96--home-llm"
DOCKER_IMAGE="acon96--home-llm_image"
HOST="localhost"
HOST_PORT=11310
CONTAINER_PORT=11310

echo "============================================"
echo "Testing acon96--home-llm on port $HOST_PORT"
echo "============================================"
...
BUILD_LOG="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/build_logs/acon96--home-llm.build.log"
...
cd "/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/repo_dirs/acon96--home-llm" || exit 1
