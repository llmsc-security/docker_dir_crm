#!/bin/bash
# invoke script for Integuru-AI--Integuru
...
if [ $BUILD_EXIT_CODE -eq 0 ]; then
    ...
    echo "  -e OPENAI_API_KEY=\${OPENAI_API_KEY} \\"
    echo "  -v \$(pwd)/logs:/app/logs \\"
    echo "  integuru-image:latest --prompt 'Your prompt here' --model gpt-4o"
else
