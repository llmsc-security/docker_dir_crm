#!/usr/bin/env python3
"""
Playwright POC test for mrwadams_attackgen.

Usage:
    python tutorial_mrwadams_attackgen_playwright.py [--url http://127.0.0.1:11110]
"""
...
# ============== CONFIGURATION ==============
REPO_NAME = "mrwadams_attackgen"
DEFAULT_PORT = 11110
# ===========================================


class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for mrwadams_attackgen."""
