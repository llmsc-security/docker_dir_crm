#!/usr/bin/env python3
"""
Playwright POC test for zwq2018--Data-Copilot.

Usage:
    python tutorial_zwq2018--Data-Copilot_playwright.py [--url http://127.0.0.1:11440]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for zwq2018--Data-Copilot."""
