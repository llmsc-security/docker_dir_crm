#!/usr/bin/env python3
"""
Playwright POC test for finaldie-auto-news.

Usage:
    python tutorial_finaldie-auto-news_playwright.py [--url http://127.0.0.1:11190]
"""
...
# ============== CONFIGURATION ==============
REPO_NAME = "finaldie-auto-news"
DEFAULT_PORT = 11190
# ===========================================


class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for finaldie-auto-news."""
