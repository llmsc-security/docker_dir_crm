#!/usr/bin/env python3
"""
Playwright POC test for yuka-friends--windrecorder.

Usage:
    python tutorial_yuka-friends--windrecorder_playwright.py [--url http://127.0.0.1:11480]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for yuka-friends--windrecorder."""
