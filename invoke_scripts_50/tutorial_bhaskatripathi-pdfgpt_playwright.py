#!/usr/bin/env python3
"""
Playwright POC test for bhaskatripathi-pdfgpt.

Usage:
    python tutorial_bhaskatripathi-pdfgpt_playwright.py [--url http://127.0.0.1:11340]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for bhaskatripathi-pdfgpt."""
