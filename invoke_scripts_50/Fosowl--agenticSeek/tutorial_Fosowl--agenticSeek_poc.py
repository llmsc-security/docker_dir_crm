...
# -*- coding: utf-8 -*-
"""
Tutorial PoC script for Fosowl--agenticSeek
Tests the HTTP service endpoints - AgenticSeek FastAPI backend.
"""
...
HOST = "localhost"
PORT = 11420
CONTAINER_PORT = 7777  # FastAPI backend port
...
def test_service():
    ...
    log(f"Container port: {CONTAINER_PORT} (FastAPI backend)")
    ...
    if passed >= 2:
        log("AgenticSeek API service is functional!", "SUCCESS")
        return 0
    else:
