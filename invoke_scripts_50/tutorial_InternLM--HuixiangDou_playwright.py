#!/usr/bin/env python3
"""
Playwright POC test for InternLM--HuixiangDou.

Usage:
    python tutorial_InternLM--HuixiangDou_playwright.py [--url http://127.0.0.1:11390]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for InternLM--HuixiangDou."""
