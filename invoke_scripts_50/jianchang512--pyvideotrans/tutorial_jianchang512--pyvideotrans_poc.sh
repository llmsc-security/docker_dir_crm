#!/bin/bash
# Tutorial PoC script for jianchang512--pyvideotrans
# Tests the HTTP service endpoint

set -e

# Absolute paths
REPO_DIR="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/repo_dirs/jianchang512--pyvideotrans"
SCRIPTS_DIR="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/invoke_scripts_50/jianchang512--pyvideotrans"
BUILD_LOG_DIR="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/build_logs"
BUILD_LOG="${BUILD_LOG_DIR}/jianchang512--pyvideotrans.build.log"

# Port mapping from port_mapping_50_gap10_1.json
# jianchang512--pyvideotrans maps to base port 11160
HOST_PORT=11160
...
log_message "Starting tutorial PoC script for jianchang512--pyvideotrans"
log_message "Target service: http://127.0.0.1:${HOST_PORT}"

echo ""
echo "=============================================="
echo "jianchang512--pyvideotrans PoC - Testing Service Endpoints"
echo "=============================================="
echo ""
