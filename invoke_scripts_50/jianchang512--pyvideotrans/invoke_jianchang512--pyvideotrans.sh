#!/bin/bash
# Invoke script for jianchang512--pyvideotrans
# Tests the HTTP service endpoint

set -e

REPO_NAME="jianchang512--pyvideotrans"
IMAGE_NAME="jianchang512--pyvideotrans_image"
CONTAINER_NAME="jianchang512--pyvideotrans_container"
PORT=11160
HOST="localhost"
CONTAINER_PORT=8000

echo "============================================"
echo "Testing jianchang512--pyvideotrans on port $PORT"
echo "============================================"
