#!/bin/bash
# Invoke script for AuvaLab--itext2kg
# Tests the HTTP service endpoint

set -e

REPO_NAME="AuvaLab--itext2kg"
IMAGE_NAME="auvalab--itext2kg_image"
CONTAINER_NAME="auvalab--itext2kg_container"
PORT=11380
HOST="localhost"
CONTAINER_PORT=11380

echo "============================================"
echo "Testing AuvaLab--itext2kg on port $PORT"
echo "============================================"
