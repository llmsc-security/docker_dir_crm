#!/usr/bin/env python3
"""
Playwright POC test for zyddnys--manga-image-translator.

Usage:
    python tutorial_zyddnys--manga-image-translator_playwright.py [--url http://127.0.0.1:11080]
"""
...
# ============== CONFIGURATION ==============
REPO_NAME = "zyddnys--manga-image-translator"
DEFAULT_PORT = 11080
# ===========================================


class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for zyddnys--manga-image-translator."""
