#!/bin/bash
# Invoke script for TauricResearch--TradingAgents
# Tests the HTTP service endpoint

set -e

REPO_NAME="TauricResearch--TradingAgents"
DOCKER_IMAGE="tauricresearch--tradingagents_image"
HOST="localhost"
HOST_PORT=11360
CONTAINER_PORT=11360

echo "============================================"
echo "Testing TauricResearch--TradingAgents on port $HOST_PORT"
echo "============================================"
...
BUILD_LOG="/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/build_logs/TauricResearch--TradingAgents.build.log"
...
cd "/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/repo_dirs/TauricResearch--TradingAgents" || exit 1
