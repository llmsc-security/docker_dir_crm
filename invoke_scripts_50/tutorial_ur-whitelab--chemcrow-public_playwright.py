#!/usr/bin/env python3
"""
Playwright POC test for ur-whitelab--chemcrow-public.

Usage:
    python tutorial_ur-whitelab--chemcrow-public_playwright.py [--url http://127.0.0.1:11120]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for ur-whitelab--chemcrow-public."""
