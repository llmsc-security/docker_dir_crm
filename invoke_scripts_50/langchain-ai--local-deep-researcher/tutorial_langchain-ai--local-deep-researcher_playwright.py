#!/usr/bin/env python3
"""
Playwright POC test for langchain-ai--local-deep-researcher.

Usage:
    python tutorial_langchain-ai--local-deep-researcher_playwright.py [--url http://127.0.0.1:11030]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for langchain-ai--local-deep-researcher."""
