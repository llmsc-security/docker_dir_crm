#!/bin/bash
# Invoke script for AntonOsika--gpt-engineer
# Tests the HTTP service endpoint

set -e

REPO_NAME="AntonOsika--gpt-engineer"
IMAGE_NAME="antonosika--gpt-engineer_image"
CONTAINER_NAME="antonosika--gpt-engineer_container"
PORT=11330
HOST="localhost"
CONTAINER_PORT=8000

echo "============================================"
echo "Testing AntonOsika--gpt-engineer on port $PORT"
echo "============================================"
