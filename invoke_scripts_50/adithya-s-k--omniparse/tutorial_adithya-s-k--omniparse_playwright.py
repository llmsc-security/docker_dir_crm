#!/usr/bin/env python3
"""
Playwright POC test for adithya-s-k--omniparse.

Usage:
    python tutorial_adithya-s-k--omniparse_playwright.py [--url http://127.0.0.1:11090]
"""
...
class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for adithya-s-k--omniparse."""
