#!/bin/bash
# Invoke script for AbanteAI--rawdog
# Tests the HTTP service endpoint

set -e

REPO_NAME="AbanteAI--rawdog"
DOCKER_IMAGE="abanteai--rawdog_image"
HOST="localhost"
HOST_PORT=11050
CONTAINER_PORT=8000

echo "============================================"
echo "Testing AbanteAI--rawdog on port $HOST_PORT"
echo "============================================"
...
cd "/home/taicen/wangjian/os_dev_google/docker_dirs_yuelin/repo_dirs/AbanteAI--rawdog" || exit 1
