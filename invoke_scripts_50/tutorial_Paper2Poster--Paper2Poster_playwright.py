#!/usr/bin/env python3
"""
Playwright POC test for Paper2Poster--Paper2Poster.

Usage:
    python tutorial_Paper2Poster--Paper2Poster_playwright.py [--url http://127.0.0.1:11320]
"""
...
# ============== CONFIGURATION ==============
REPO_NAME = "Paper2Poster--Paper2Poster"
DEFAULT_PORT = 11320
# ===========================================


class RepoPlaywrightTest(PlaywrightBaseTest):
    """Playwright test for Paper2Poster--Paper2Poster."""
